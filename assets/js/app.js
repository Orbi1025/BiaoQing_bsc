...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (primaryHeader) {
    ...
    window.matchMedia(mdScreen).addEventListener("change", function (e) {
      var subMenus = primaryHeader.querySelectorAll(
  ...
  if (copyBtn && input) {
    copyBtn.addEventListener("click", function () {
      ...
      if (
        (_navigator$clipboard = navigator.clipboard) !== null &&
        _navigator$clipboard !== void 0 &&
        _navigator$clipboard.writeText
      ) {
        navigator.clipboard
  ...
  mm.add("(min-width: 1200px)", function () {
    ...
    function rocketLaunch() {
      var rocketLaunch = document.querySelector(
...
function redirectToRememberedHome(targetId) {
  var currentPath = window.location.pathname.substring(
    0,
