...
(function (global, factory) {
    ...
    if (document.readyState === "loading") {
      ...
      if (!DOMContentLoadedCallbacks.length) {
        document.addEventListener("DOMContentLoaded", function () {
          for (
            var _i2 = 0, _DOMContentLoadedCall = DOMContentLoadedCallbacks;
  ...
  var execute = function execute(possibleCallback) {
    ...
    return typeof possibleCallback === "function"
      ? possibleCallback.call.apply(possibleCallback, _toConsumableArray(args))
      : defaultValue;
  };
  var executeAfterTransition = function executeAfterTransition(
    callback,
    transitionElement
  ) {
   ...
   */
  var getNextActiveElement = function getNextActiveElement(
    list,
    activeElement,
    shouldGetNext,
    isCycleAllowed
  ...
  function addHandler(
    ...
    var _normalizeParameters = normalizeParameters(
        originalTypeEvent,
        handler,
        delegationFunction
      ),
    ...
    var previousFunction = findHandler(
      handlers,
      callable,
  ...
  function removeNamespacedHandlers(element, events, typeEvent, namespace) {
    ...
    for (
      var _i3 = 0, _Object$entries = Object.entries(storeElementEvent);
  ...
  var EventHandler = {
    ...
    off: function off(element, originalTypeEvent, handler, delegationFunction) {
      ...
      var _normalizeParameters3 = normalizeParameters(
          originalTypeEvent,
          handler,
          delegationFunction
        ),
      ...
      for (
        var _i5 = 0, _Object$entries2 = Object.entries(storeElementEvent);
  ...
  function hydrateObj(obj) {
    ...
    for (
      var _i6 = 0, _Object$entries3 = Object.entries(meta);
  ...
  var Manipulator = {
    ...
    getDataAttribute: function getDataAttribute(element, key) {
      return normalizeData(
        element.getAttribute("data-bs-".concat(normalizeDataKey(key)))
      );
    },
  };
      ...
      [
            ...
            return _objectSpread(
              _objectSpread(
                _objectSpread(
                  ...
                  _typeof(jsonConfig) === "object" ? jsonConfig : {}
                ),
                isElement$1(element)
        ...
        },
        {
          ...
          value: function _typeCheckConfig(config) {
            ...
            for (
              var _i7 = 0, _Object$entries4 = Object.entries(configTypes);
              ...
              if (!new RegExp(expectedTypes).test(valueType)) {
                throw new TypeError(
                  ""
                    ...
                    .concat(valueType, '" but expected type "')
        ...
        },
        {
          ...
          value: function getOrCreateInstance(element) {
            ...
            return (
              ...
              new this(element, _typeof(config) === "object" ? config : null)
            );
          },
        },
        {
  ...
  var SelectorEngine = {
    ...
    getMultipleElementsFromSelector: function getMultipleElementsFromSelector(
      element
    ) {
      var selector = getSelector(element);
  ...
  var EVENT_CLICK_DATA_API$6 = "click"
    .concat(EVENT_KEY$a)
    .concat(DATA_API_KEY$6);
  ...
  var EVENT_CLICK_DATA_API$5 = "click"
    .concat(EVENT_KEY$8)
    .concat(DATA_API_KEY$5);
  ...
  var KEY_TO_DIRECTION = _defineProperty(
    _defineProperty({}, ARROW_LEFT_KEY$1, DIRECTION_RIGHT),
    ARROW_RIGHT_KEY$1,
    DIRECTION_LEFT
  );
  var Default$b = {
  ...
  var Carousel = /*#__PURE__*/ (function (_BaseComponent3) {
    function Carousel(element, config) {
      ...
      _this5._indicatorsElement = SelectorEngine.findOne(
        SELECTOR_INDICATORS,
        _this5._element
      );
      ...
      [
          ...
          value: function _addTouchEventListeners() {
            ...
            var swipeConfig = {
              leftCallback: function leftCallback() {
                return _this10._slide(
                  _this10._directionToOrder(DIRECTION_LEFT)
                );
              },
              rightCallback: function rightCallback() {
                return _this10._slide(
                  _this10._directionToOrder(DIRECTION_RIGHT)
                );
              },
        ...
        },
        {
          ...
          value: function _setActiveIndicatorElement(index) {
            ...
            var newActiveIndicator = SelectorEngine.findOne(
        ...
        },
        {
          ...
          value: function _slide(order) {
            ...
            var directionalClassName = isNext
              ? CLASS_NAME_START
              : CLASS_NAME_END;
  ...
  var EVENT_CLICK_DATA_API$4 = "click"
    .concat(EVENT_KEY$7)
    .concat(DATA_API_KEY$4);
  var CLASS_NAME_SHOW$7 = "show";
  var CLASS_NAME_COLLAPSE = "collapse";
  var CLASS_NAME_COLLAPSING = "collapsing";
  var CLASS_NAME_COLLAPSED = "collapsed";
  var CLASS_NAME_DEEPER_CHILDREN = ":scope ."
    .concat(CLASS_NAME_COLLAPSE, " .")
    .concat(CLASS_NAME_COLLAPSE);
  ...
  var Collapse = /*#__PURE__*/ (function (_BaseComponent4) {
    function Collapse(element, config) {
      ...
      if (!_this12._config.parent) {
        _this12._addAriaAndCollapsedClass(
          _this12._triggerArray,
          _this12._isShown()
        );
      }
        ...
        },
        {
          ...
          value: function show() {
            ...
            var complete = function complete() {
              ...
              _this13._element.classList.add(
                CLASS_NAME_COLLAPSE,
                CLASS_NAME_SHOW$7
              );
  ...
  */
  ...
  var EVENT_CLICK_DATA_API$3 = "click"
    .concat(EVENT_KEY$6)
    .concat(DATA_API_KEY$3);
  var EVENT_KEYDOWN_DATA_API = "keydown"
    .concat(EVENT_KEY$6)
    .concat(DATA_API_KEY$3);
  ...
  var SELECTOR_DATA_TOGGLE$3 =
    '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)';
  var SELECTOR_DATA_TOGGLE_SHOWN = ""
    .concat(SELECTOR_DATA_TOGGLE$3, ".")
    .concat(CLASS_NAME_SHOW$6);
  ...
  var Dropdown = /*#__PURE__*/ (function (_BaseComponent5) {
    function Dropdown(element, config) {
      ...
      _this15._menu =
        SelectorEngine.next(_this15._element, SELECTOR_MENU)[0] ||
        SelectorEngine.prev(_this15._element, SELECTOR_MENU)[0] ||
        SelectorEngine.findOne(SELECTOR_MENU, _this15._parent);
      ...
      [
        ...
        },
        {
          ...
          value: function _getConfig(config) {
            ...
            if (
              _typeof(config.reference) === "object" &&
      ...
      [
        ...
        },
        {
          ...
          value: function dataApiKeydownHandler(event) {
            ...
            var isUpOrDownEvent = [ARROW_UP_KEY$1, ARROW_DOWN_KEY$1].includes(
              event.key
            );
            ...
            // TODO: v6 revert #37011 & change markup https://getbootstrap.com/docs/5.3/forms/input-group/
            var getToggleButton = this.matches(SELECTOR_DATA_TOGGLE$3)
              ? this
  ...
  var ScrollBarHelper = /*#__PURE__*/ (function () {
    ...
    return _createClass(ScrollBarHelper, [
      ...
      },
      {
        ...
        value: function _setElementAttributes(
          selector,
          styleProperty,
          callback
        ) {
  ...
  var EVENT_CLICK_DATA_API$2 = "click"
    .concat(EVENT_KEY$4)
    .concat(DATA_API_KEY$2);
  ...
  var Modal = /*#__PURE__*/ (function (_BaseComponent6) {
    function Modal(element, config) {
      ...
      _this23._dialog = SelectorEngine.findOne(
        SELECTOR_DIALOG,
        _this23._element
      );
            ...
            EventHandler.on(
              ...
              function (event) {
                ...
                EventHandler.one(
                  ...
                  function (event2) {
                    if (
                      _this27._element !== event.target ||
                      _this27._element !== event2.target
                    ) {
                      return;
                    }
  ...
  var EVENT_CLICK_DATA_API$1 = "click"
    .concat(EVENT_KEY$3)
    .concat(DATA_API_KEY$1);
      ...
      [
        ...
        },
        {
          ...
          value: function hide() {
            ...
            this._backdrop.hide();
            var completeCallback = function completeCallback() {
              _this33._element.classList.remove(
                CLASS_NAME_SHOW$3,
                CLASS_NAME_HIDING
              );
  ...
  EventHandler.on(window, EVENT_RESIZE, function () {
    var _iterator17 = _createForOfIteratorHelper(
        SelectorEngine.find("[aria-modal][class*=show][class*=offcanvas-]")
      ),
      _step17;
    try {
  ...
  function sanitizeHtml(unsafeHtml, allowList, sanitizeFunction) {
    ...
    var elements = (_ref12 = []).concat.apply(
      _ref12,
    ...
    try {
      for (_iterator18.s(); !(_step18 = _iterator18.n()).done; ) {
        ...
        var attributeList = (_ref13 = []).concat.apply(
          _ref13,
      ...
      [
        ...
        },
        {
          ...
          value: function toHtml() {
            ...
            for (
              var _i8 = 0,
                _Object$entries5 = Object.entries(this._config.content);
            ...
            var extraClass = this._resolvePossibleFunction(
              this._config.extraClass
            );
            if (extraClass) {
              var _template$classList;
              (_template$classList = template.classList).add.apply(
                _template$classList,
      ...
      [
        ...
        },
        {
          ...
          value: function show() {
            ...
            var complete = function complete() {
              EventHandler.trigger(
                _this40._element,
                _this40.constructor.eventName(EVENT_SHOWN$2)
              );
        ...
        },
        {
          ...
          value: function hide() {
            ...
            var complete = function complete() {
              ...
              EventHandler.trigger(
                _this41._element,
                _this41.constructor.eventName(EVENT_HIDDEN$2)
              );
            };
            this._queueCallback(complete, this.tip, this._isAnimated());
          },
        ...
        },
        {
          ...
          value: function _getConfig(config) {
            ...
            for (
              var _i10 = 0, _Object$keys2 = Object.keys(dataAttributes);
        ...
        },
        {
          ...
          value: function _getDelegateConfig() {
            var config = {};
            for (
              var _i11 = 0, _Object$entries7 = Object.entries(this._config);
  ...
  var DefaultType$2 = _objectSpread(
    ...
    return _createClass(
      ...
      [
        ...
        },
        {
          ...
          value: function _getContentForTemplate() {
            return _defineProperty(
              _defineProperty({}, SELECTOR_TITLE, this._getTitle()),
              SELECTOR_CONTENT,
              this._getContent()
            );
          },
  ...
  var SELECTOR_LINK_ITEMS = ""
    .concat(SELECTOR_NAV_LINKS, ", ")
    .concat(SELECTOR_NAV_ITEMS, " > ")
    .concat(SELECTOR_NAV_LINKS, ", ")
    .concat(SELECTOR_LIST_ITEMS);
  ...
  var ScrollSpy = /*#__PURE__*/ (function (_BaseComponent9) {
    function ScrollSpy(element, config) {
      ...
      _this47._rootElement =
        getComputedStyle(_this47._element).overflowY === "visible"
          ? null
          : _this47._element;
      ...
      [
        ...
        },
        {
          ...
          value: function _maybeEnableSmoothScroll() {
            ...
            EventHandler.on(
              ...
              function (event) {
                var observableSection = _this48._observableSections.get(
                  event.target.hash
                );
                if (observableSection) {
                  ...
                  var height =
                    observableSection.offsetTop - _this48._element.offsetTop;
                  if (root.scrollTo) {
                    root.scrollTo({
                      top: height,
                      behavior: "smooth",
        ...
        },
        {
          ...
          value: function _observerCallback(entries) {
            ...
            var activate = function activate(entry) {
              _this50._previousScrollData.visibleEntryTop =
        ...
        },
        {
          ...
          value: function _initializeTargetsAndObservables() {
            ...
            var targetLinks = SelectorEngine.find(
              SELECTOR_TARGET_LINKS,
              this._config.target
            );
            ...
            try {
              for (_iterator25.s(); !(_step25 = _iterator25.n()).done; ) {
                ...
                var observableSection = SelectorEngine.findOne(
            ...
            try {
              for (_iterator26.s(); !(_step26 = _iterator26.n()).done; ) {
                ...
                var _iterator27 = _createForOfIteratorHelper(
                    SelectorEngine.prev(listGroup, SELECTOR_LINK_ITEMS)
                  ),
                  _step27;
                try {
        ...
        },
        {
          ...
          value: function _clearActiveClass(parent) {
            ...
            var activeNodes = SelectorEngine.find(
              "".concat(SELECTOR_TARGET_LINKS, ".").concat(CLASS_NAME_ACTIVE$1),
              parent
            );
  ...
  var NOT_SELECTOR_DROPDOWN_TOGGLE = ":not(".concat(
    SELECTOR_DROPDOWN_TOGGLE,
    ")"
  );
  var SELECTOR_TAB_PANEL = '.list-group, .nav, [role="tablist"]';
  var SELECTOR_OUTER = ".nav-item, .list-group-item";
  var SELECTOR_INNER = ".nav-link"
    .concat(NOT_SELECTOR_DROPDOWN_TOGGLE, ", .list-group-item")
    .concat(NOT_SELECTOR_DROPDOWN_TOGGLE, ', [role="tab"]')
    .concat(NOT_SELECTOR_DROPDOWN_TOGGLE);
  ...
  var SELECTOR_INNER_ELEM = ""
    .concat(SELECTOR_INNER, ", ")
    .concat(SELECTOR_DATA_TOGGLE);
  var SELECTOR_DATA_TOGGLE_ACTIVE = "."
    .concat(CLASS_NAME_ACTIVE, '[data-bs-toggle="tab"], .')
    .concat(CLASS_NAME_ACTIVE, '[data-bs-toggle="pill"], .')
    .concat(CLASS_NAME_ACTIVE, '[data-bs-toggle="list"]');
        ...
        },
        {
          ...
          value: function _keydown(event) {
            ...
            if ([HOME_KEY, END_KEY].includes(event.key)) {
              ...
              var isNext = [ARROW_RIGHT_KEY, ARROW_DOWN_KEY].includes(
                event.key
              );
        ...
        },
        {
          ...
          value: function hide() {
            ...
            var complete = function complete() {
              ...
              _this57._element.classList.remove(
                CLASS_NAME_SHOWING,
                CLASS_NAME_SHOW
              );
